...
suspend fun main() {
	...
	// We have to use a IR plugin like Ktorfit uses to replace the KProxy.create call with the generated proxy class
	val myInterface = KProxy.create<MyInterface>(handler = loggingHandler, proxy = _MyInterfaceProxy(loggingHandler))
