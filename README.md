...
```kotlin
plugins {
    id("io.github.elianfabian.kproxyable") version "1.0.3"
}
```
...
dependencies {
    implementation("io.github.elianfabian:kproxyable-runtime:1.0.3")
    ksp("io.github.elianfabian:kproxyable-processor:1.0.3")
}
```
